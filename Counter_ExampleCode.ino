...
const char* ssid = "4G Wi-Fi 3Danmark-F020"; //Indsæt navnet på jeres netværk her
const char* password = "doughnut"; //Indsæt password her
...
const int mqtt_port = 18268; // Definerer porten
const char *mqtt_user = "Mekatronik20"; // Definerer mqtt-brugeren
const char *mqtt_pass = "Mekatronik20"; // Definerer koden til mqtt-brugeren
//
